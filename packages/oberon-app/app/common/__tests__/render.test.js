...
describe('buildRenderContext()', () => {
  ...
  it('rendered parent same name environment variables', async () => {
    ...
    expect(context).toEqual({ base_url: 'https://oberon.rest/resource' });
  });
  ...
  it('cascades properly and renders', async () => {
    ...
    const subEnvironment = {
      type: models.environment.type,
      data: { winner: 'sub', sub: true, base_url: 'https://oberon.rest' },
    };
    ...
    expect(context).toEqual({
      base_url: 'https://oberon.rest',
      url: 'https://oberon.rest/resource',
      ancestor: true,
      winner: 'folder parent',
      root: true,
      sub: true,
