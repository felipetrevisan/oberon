...
import { buildQueryStringFromParams, joinUrlAndQueryString } from 'oberon-url';
...
async function getUpdateUrl(force: boolean): Promise<string | null> {
  ...
  if (process.env.OBERON_DISABLE_AUTOMATIC_UPDATES) {
    console.log(`[updater] Disabled by OBERON_DISABLE_AUTOMATIC_UPDATES environment variable`);
    return null;
  }
