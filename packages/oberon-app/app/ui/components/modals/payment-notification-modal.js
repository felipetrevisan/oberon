  ...
  render() {
    return (
      <Modal ref={this._setModalRef}>
        <ModalHeader>Oberon Plus Trial Ended</ModalHeader>
        <ModalBody className="pad changelog">
          <div className="text-center pad">
            <h1>Hi {getFirstName()},</h1>
            <p style={{ maxWidth: '30rem', margin: 'auto' }}>
              Your Oberon Plus trial has come to an end. Please enter your billing info to
            ...
            <p className="pad-top">
              ...
              <Link
                button
                href="https://oberon.rest/app/subscribe/"
