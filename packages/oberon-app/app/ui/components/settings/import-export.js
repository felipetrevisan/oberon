...
class ImportExport extends PureComponent {
  _handleImportUri() {
    showPrompt({
      ...
      label: 'URL',
      placeholder: 'https://website.com/oberon-import.json',
      onComplete: uri => {
    ...
    return (
      <div>
        <p className="no-margin-top">
          ...
          <strong>Oberon, Postman v2, HAR, Curl, Swagger, OpenAPI v3</strong>)
        </p>
        <p>
          Don't see your format here?{' '}
          <Link href="https://support.oberon.rest/article/52-importing-and-exporting-data">
            Add Your Own
          </Link>
          .
        </p>
        <div className="pad-top">
          ...
          &nbsp;&nbsp;
          <Link href="https://oberon.rest/create-run-button/" className="btn btn--compact" button>
            Create Run Button
          </Link>
        </div>
