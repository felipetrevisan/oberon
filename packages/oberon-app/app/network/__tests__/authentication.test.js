...
describe('OAuth 1.0', () => {
  it('Does OAuth 1.0', async () => {
    const authentication = {
      ...
      callback: 'https://oberon.rest/callback/',
      tokenKey: 'tokenKey',
    ...
    const request = { url: 'https://oberon.rest/', method: 'GET', authentication };
    const header = await getAuthHeader(request, 'https://oberon.rest/');

    expect(header).toEqual({
      name: 'Authorization',
      value: [
        'OAuth ' + 'oauth_callback="https%3A%2F%2Foberon.rest%2Fcallback%2F"',
